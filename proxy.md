...
proxy.name // "张三"
proxy.age // 抛出一个错误  Uncaught ReferenceError: Prop name "age" does not exist.

{ name: "张三" }.name // Uncaught SyntaxError: Unexpected token '.'
{ name: "张三" }.age // Uncaught SyntaxError: Unexpected token '.'
...
Number(propKey) // 数组索引 String 转发为 Number
...elements
Reflect P259
```
...
// <div>Hello, my name is <a href="//example.com">Mark</a>. I like:<ul><li>The web</li><li>Food</li><li>…actually that's it</li></ul></div>

<div>
    Hello, my name is <a href="//example.com">Mark</a> . I like:
    <ul>
        <li>The web</li>
        <li>Food</li>
