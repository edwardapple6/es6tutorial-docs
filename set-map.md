...
// 去除数组的重复成员
[...new Set(array)]
[...new Set([1,2,3,4,5,6,1,2,3,4,5,6])] // [1, 2, 3, 4, 5, 6]
```
...
new WeakSet().add(Object()) // WeakSet {{…}}
new WeakSet().add(Object({"0": [1, 2]})) // WeakSet {{…}}
// WeakSet {{…}}
//   [[Entries]]
//     0:
//       value:
...
new WeakSet([[1, 2], [3, 4]]) // WeakSet {Array(2), Array(2)}
new WeakSet([[1, 2]])         // WeakSet {Array(2)}
new WeakSet([1, 2])           // Uncaught TypeError: Invalid value used in weak set
new WeakSet(["a", "b"])       // Uncaught TypeError: Invalid value used in weak set
new WeakSet({"0": [1, 2], length: 1}); // Uncaught TypeError: object is not iterable (cannot read property Symbol(Symbol.iterator))
...
new Map([['name', '张三'], ['title', 'Author']]); // Map(2) {'name' => '张三', 'title' => 'Author'}
...
console.log("I'm %s and I'm %d years old", "John", 10)
// I'm John and I'm 10 years old
```
