...
console.log(str) // abc
console.log(iter) // StringIterator {}
iter.next() // {value: 'a', done: false}
iter.next() // {value: 'b', done: false}
iter.next() // {value: 'c', done: false}
iter.next() // {value: undefined, done: true}
...
class RangeIterator {
  ...
  [Symbol.iterator]() { return this; console.log(this);} // ???
...
let iter = RangeIterator[Symbol.iterator](); // TypeError: RangeIterator[Symbol.iterator] is not a function
...
one.next = new Obj(2);
console.log(one); // Obj {value: 1, next: Obj}
```
...
for (var i of obj){
  console.log(i); // TypeError: Cannot set property 'Symbol(Symbol.iterator)' of undefined
}


console.log([1, 2, 3]); // __proto__: Array(0)
console.log(document.querySelectorAll("div")); // __proto__: NodeList
document.querySelectorAll("div") instanceof Array; // false
document.querySelectorAll("div") instanceof Object; // true
...
console.log(es6); // Map(3) {'edition' => 6, 'committee' => 'TC39', 'standard' => 'ECMA-262'}
